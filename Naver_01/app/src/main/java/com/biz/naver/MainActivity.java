...
import com.biz.naver.config.NaverSecurity;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
            TextInputEditText에 imeOptions="actionSearch" 옵션을 설정해 만들어진
                    ...
                    if(strSearch.isEmpty()){
                       ...
                       //  naverSearch.execute();
                        Call<NaverMovie> naverCall = RetrofitClient.getInstance().getMovie(
                                NaverSecurity.NAVER_ID,
                                NaverSecurity.NAVER_SEC,
                                strSearch
                        );

                        /*
                             2020.02.26 enqueue Call Back 설명 필요
                         */
