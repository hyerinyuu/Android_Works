...
public class MainActivity extends AppCompatActivity {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                /*
                    ...
                    다른 화면을 보이고자 할 때는
                    Intent를 만들고 startActivity() method를 사용하여 intent를 열어준다.
                 */
                ...
                // 이미지를 저장하는 공간
                // 내장 메모리, 외장 SD카드가 있는데 모두 나에게 접근할 수 있게 해달라 라는 설정
                imgIntent.setData(MediaStore.Images.Media.EXTERNAL_CONTENT_URI);

                // 이미지 보기 열었을 때 이미지를 클릭하면
    ...
    // alt + insert ==> show override / implement menu
    // 현재 Activity에서 새로운 Activity를 열었을 때
    // 새로운 Activity가 어떤 값을 되돌려주면 그 값을 수신할 method
    @Override
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == RequestCode.REQUEST_IMAGE_CODE){
            ...
            if(resultCode == RequestCode.RESULT_OK){
                ...
                Toast.makeText(MainActivity.this, "입력오류발생", Toast.LENGTH_SHORT).show();
            }
